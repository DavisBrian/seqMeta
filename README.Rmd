...
[![AppVeyor Build Status](https://ci.appveyor.com/api/projects/status/github/DavisBrian/seqMeta?branch=master)](https://ci.appveyor.com/project/DavisBrian/seqMeta)
...
```
<<<<<<< HEAD
* the latest development version for testing by downloading seqMeta_1.5.0.9028.tar.gz and running 
    ```R
    install.packages("/path/to/file/seqMeta_1.5.0.9028.tar.gz", type = "source")
=======
* the latest development version for testing by downloading seqMeta_1.5.0.9027.tar.gz and running 
    ```R
